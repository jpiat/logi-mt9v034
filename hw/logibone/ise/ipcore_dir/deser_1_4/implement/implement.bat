...
xst -ifn xst.scr
move deser_1_4_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\deser_1_4_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc deser_1_4_exdes.ucf deser_1_4_exdes

echo 'Running map'
map -timing deser_1_4_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm deser_1_4_exdes -w routed.ncd routed.vhd
cd ..
